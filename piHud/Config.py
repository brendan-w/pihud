...
defaults = {
	...
	c.ENGINE_LOAD       : WidgetConfig("Bar_h", 0, 100, 90),
	c.COOLANT_TEMP      : WidgetConfig("Bar_h", -40, 215),
	c.SHORT_FUEL_TRIM_1 : WidgetConfig("Bar_h", -100, 100),
	c.LONG_FUEL_TRIM_1  : WidgetConfig("Bar_h", -100, 100),
	c.SHORT_FUEL_TRIM_2 : WidgetConfig("Bar_h", -100, 100),
	c.LONG_FUEL_TRIM_2  : WidgetConfig("Bar_h", -100, 100),
	c.FUEL_PRESSURE     : WidgetConfig("Bar_h", 0, 765),
	c.INTAKE_PRESSURE   : WidgetConfig("Bar_h", 0, 255),
	c.RPM               : WidgetConfig("Bar_h", 0, 8000, 6750),
	c.SPEED             : WidgetConfig("Bar_h", 0, 180),
	c.TIMING_ADVANCE    : WidgetConfig("Bar_h", -64, 64),
	c.INTAKE_TEMP       : WidgetConfig("Bar_h", -40, 215),
	c.MAF               : WidgetConfig("Bar_h", 0, 655.35),
	c.THROTTLE_POS      : WidgetConfig("Bar_h", 0, 100),
	c.AIR_STATUS        : WidgetConfig("Text", label_font_size=50),
	#c.O2_SENSORS        : WidgetConfig(),
	c.O2_B1S1           : WidgetConfig("Bar_h", 0, 1.275),
	c.O2_B1S2           : WidgetConfig("Bar_h", 0, 1.275),
	c.O2_B1S3           : WidgetConfig("Bar_h", 0, 1.275),
	c.O2_B1S4           : WidgetConfig("Bar_h", 0, 1.275),
	c.O2_B2S1           : WidgetConfig("Bar_h", 0, 1.275),
	c.O2_B2S2           : WidgetConfig("Bar_h", 0, 1.275),
	c.O2_B2S3           : WidgetConfig("Bar_h", 0, 1.275),
	c.O2_B2S4           : WidgetConfig("Bar_h", 0, 1.275),
